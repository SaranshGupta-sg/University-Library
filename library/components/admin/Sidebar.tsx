...
const Sidebar = ({ session }: { session: Session }) => {
  ...
  return (
    <div className="h-screen sticky left-0 top-0 flex flex-col bg-white px-5 pb-5 pt-10">
      ...
      <div className="mt-42 flex w-full flex-row gap-2 rounded-full border border-[#EDF1F1] px-6 py-2 shadow-sm max-md:px-2">
        <Avatar>
          <AvatarFallback className="bg-amber-100 text-amber-950">
